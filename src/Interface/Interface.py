...
class interface(load_elements,BaseMenu):
    ...
    def menu_AI(self):
        ...
        type_training_ai=pygame_gui.elements.UIButton(relative_rect=Rect(self.WIDTH-120, 200, 110, 50),text="Change",object_id="#button_on",manager=self.manager,command=lambda:self.more_options(command=lambda:self.change_mains(8,fade=False)))
